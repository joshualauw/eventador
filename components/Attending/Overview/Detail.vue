<template>
    <div class="card h-fit hover:scale-100 w-[60%]">
        ...
        <div class="card-body space-y-4">
            ...
            <p class="text-content2">
                ...
                consectetur adipisicing elit. Dolorum odit soluta ex dolore minus officia eum quidem dignissimos quam
                eveniet, ipsam quaerat, hic quasi nemo. Eos inventore consectetur harum reiciendis.
            </p>
                    ...
                    <div v-for="i in 5" class="card hover:scale-100 shadow-none">
                        <div class="flex flex-row gap-4 p-4 card-body bg-backgroundPrimary">
                            ...
                            <div class="flex flex-col">
                                ...
                                <span class="text-sm text-primary">Organizer</span>
                            </div>
                        </div>
                    </div>
                </div>
