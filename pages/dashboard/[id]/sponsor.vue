<template>
    ...
    <OrganizerModalSponsorEdit :context="actionContext" :update-id="actionId" />
    <OrganizerModalSponsorDelete :label="actionLabel" :id="actionId" />
    <OrganizerModalSponsorDetail :detail-id="actionId" />
</template>
