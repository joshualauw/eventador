<template>
    ...
    <UIModal v-slot="{ setOpen }" modal-id="submit-response-modal">
        <div class="flex flex-col text-center gap-2">
            <div class="flex-box rounded-full w-14 h-14 p-4 btn btn-solid-warning btn-no-animation self-center mb-4">
            ...
            <button @click="doSubmitResponse(setOpen)" class="btn btn-warning mt-4" :class="{ 'btn-loading': pending }">
                Yes, Submit
            </button>
        </div>
    </UIModal>
